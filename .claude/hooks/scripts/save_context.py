...
Triggered by:
  - SessionEnd (reason: "clear")  → Final save right before /clear (E1: Dedup exempt)
  - PreCompact (auto|manual)      → Save right before automatic compaction
  - threshold (token 75%+)        → Called from update_work_log.py
