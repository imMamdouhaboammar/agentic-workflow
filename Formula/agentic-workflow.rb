class AgenticWorkflow < Formula
  ...
  url "https://github.com/imMamdouhaboammar/agentic-workflow/archive/refs/tags/v1.2.2.tar.gz"
  license "MIT"
  ...
  test do
    assert_match "agentic-workflow v1.2.2", shell_output("#{bin}/agentic-workflow --version")
  end
end
