...
**Terminology**:
- Technical terms: Standard translation + English in parentheses on FIRST occurrence only.
  - Example: "Single Source of Truth (SOT)"
  - Subsequent occurrences: use standardized term.
